...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250416072048_Add_HabitTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Database.Entities.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Database.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Api.Database.Entities.HabitTag", b =>
                {
                    b.HasOne("DevHabit.Api.Database.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                    ...
                    b.HasOne("DevHabit.Api.Database.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
